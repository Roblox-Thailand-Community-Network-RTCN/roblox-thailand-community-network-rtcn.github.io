...
const translations = {
    en: {
        ...
        'role-bloxnews':    'Head of BloxNews TH',
    ...
    th: {
        ...
        'hero-title':       'เชื่อมโยงชุมชนไทยเข้าด้วยกัน',
        'collab-title':     'ร่วมงานกับ',
        ...
        'stat-note':    '*ณ ไตรมาสที่ 2 ของปี 2026',

        'features-title': 'ทำไมต้องเลือกเรา?',
        'feat1-title':  'ปลอดภัยและมั่นคง',
        'feat1-desc':   'เราให้ความสำคัญกับความปลอดภัยและความมั่นคงของสมาชิกในชุมชนเป็นอันดับแรก ผ่านการดูแลและการกำหนดแนวทางปฏิบัติที่เข้มแข็งในทุกกลุ่ม เซิร์ฟเวอร์ และชุมชนต่างๆ ของเรา',
        'feat2-title':  'บริการดูแลอย่างใกล้ชิดแบบส่วนตัว',
        'feat2-desc':   'ทีมงานของเราพร้อมให้ความช่วยเหลือและสนับสนุนทรัพยากรต่าง ๆ สำหรับทั้งนักพัฒนาและผู้เล่นอยู่เสมอ',
        'feat3-title':  'เครือข่ายที่กำลังเติบโต',
        'feat3-desc':   'เชื่อมต่อกับผู้คนที่มีความสนใจคล้ายกัน เหล่าครีเอเตอร์ และผู้ชื่นชอบ Roblox นับพันคนทั่วประเทศไทย',

        'team-title':       'ทีมงานของเรา',
        'role-founder':     'ผู้ก่อตั้ง RTCN',
        'role-cofounder':   'ผู้ร่วมก่อตั้ง RTCN',
        'role-bloxnews':    'หัวหน้า BloxNews',
